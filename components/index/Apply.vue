                    ...
                    <div class="apply__variant" @click.stop>
                        <div>
                            ...
                            <div class="apply-details" v-if="isVarOpen(1)">
                                <!-- «Большие данные» и «Программирование и информационные технологии», «Искусственный
                                    интеллект, «Программирование и информационные, технологии», «Программная инженерия», «Математика», «Информационная и
                                    кибербезопасность», «Бизнес-информатика» -->
                                <p>Медалисты и победители по направлениям «Информационная и кибербезопасность»,«Искусственный интеллект», «Машинное обучение»,
                                    «Программирование и информационные технологии» и «Программная инженерия» получают максимальный результат по вступительным испытаниям (100 баллов).</p>
                                <span>Для поступления:</span>
                                <ol>
