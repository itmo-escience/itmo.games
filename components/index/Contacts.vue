    ...
    <div class="wrapper" id="contacts">
        ...
        <div class="container mx-auto px-4 flex">
            <article class="contacts">
                <div class="info">
                    <p class="about">
                        Программа реализуется в Университете ИТМО на базе
                        <a href="http://www.ifmo.ru/ru/viewfaculty/107/megafakultet_translyacionnyh_informacionnyh_tehnologiy.htm">мегафакультета
                            трансляционных информационных технологий</a>
                    </p>
                    <div class="info-line">
                    ...
                    <div class="info-line"><img src="/icons/phone.png" alt="">
                        <p>+7 (999) 235-6494</p></div>
                    <div class="info-line"><img src="/icons/mail.png" alt="">
                        <p><a href="mailto:alexgoodwin@corp.ifmo.ru">alexgoodwin@corp.ifmo.ru</a></p>
                    </div>
                    <a class="vk" href="https://vk.com/itmogamedev">
                    ...
                    <form ref="form" @submit.prevent="sendMessage()">
                        ...
                        <div>
                            ...
                            <select v-model="messageType">
                                <option value="1">Хочу поступить в магистратуру</option>
                                <option value="2">Хочу предложить партнерство</option>
                            </select>
                        </div>
                        <div>
                            <input type="email" placeholder="E-mail" name="email" v-model="email" required>
                            <input type="text" placeholder="Телефон" name="phone" v-model="phone" required>
                        </div>
                        <div>
                            <input class="fullInput" type="text" placeholder="Вопрос (необязательно)" name="message" v-model="message">
                        </div>
    ...
    export default {
        ...
        methods: {
            sendMessage: function () {
                ...
                params.append('messageType', this.messageType);
                ...
                axios.post('http://itmo.games/index.php', params)
