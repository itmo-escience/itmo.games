                        ...
                        <div class="overview">
                            ...
                            <div class="flex">
                                ...
                                <div class="desc">
                                    ...
                                    <div class="desc-body">
                                        <div class="course">{{ g.course }}</div>
                                        <div>{{ g.authors.join() }}</div>
                                    </div>
        ...
        return{
            ...
            games: {
                'SUPERMASSIVE BLACK HOLE': {
                    ...
                    video: 'vkd-wUrAHck',
                    course: '2 семестр "Инструментальные средства разработки видеоигр" Курсовой проект',
                ...
                'Smart Ass': {
                    ...
                    video: 'S7JNxA1PgKk',
                    course: 'Личный независимый проект - третий семестр',
                ...
                'The Gate': {
                    ...
                    video: '6_fbjVN307E',
                    course: '1 семестр Курсовой проект - "Введение в игровую разработку"',
