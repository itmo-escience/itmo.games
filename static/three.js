...
THREE.extend(THREE.Vector3.prototype, {
    set: function (a, b, c) {
        ...
        var b = this.x, c = this.y, d = this.z, e = a.x, f = a.y, g = a.z, a = a.w, h = a * b + f * d - g * c, i = a * c + g * b - e * d,
            k = a * d + e * c - f * b, b = -e * b - f * c - g * d;
...
THREE.extend(THREE.Matrix4.prototype, {
    set: function (a, b, c, d, e, f, g, h, i, k, l, m, n, s, r, p) {
        ...
        var c = a.elements, d = b.elements, e = this.elements, f = c[0], g = c[4], h = c[8], i = c[12], k = c[1], l = c[5], m = c[9], n = c[13], s = c[2],
            r = c[6], p = c[10], q = c[14], y = c[3], v = c[7], z = c[11], c = c[15], t = d[0], A = d[4], I = d[8], C = d[12], x = d[1], G = d[5], J = d[9],
        ...
        var c = this.elements, d = a.elements, e = d[0], f = d[4], g = d[8], h = d[12], i = d[1], k = d[5], l = d[9], m = d[13], n = d[2], s = d[6], r = d[10],
            p = d[14], q = d[3], y = d[7], v = d[11], z = d[15];
        ...
        var a = new THREE.Vector3;
        return function (b) {
            var c = this.elements, b = b.elements, d = 1 / a.set(b[0], b[1], b[2]).length(), e = 1 / a.set(b[4], b[5], b[6]).length(),
        ...
        var d = a.x, e = a.y, f = a.z, g = Math.sqrt(d * d + e * e + f * f), d = d / g, e = e / g, f = f / g, g = d * d, h = e * e, i = f * f, k = Math.cos(b),
            l = Math.sin(b), m = 1 - k, n = d * e * m, s = d * f * m, m = e * f * m, d = d * l, r = e * l, l = f * l, f = g + (1 - g) * k, g = n + l, e = s - r,
            n = n - l, h = h + (1 - h) * k, l = m + d, s = s + r, m = m - d, i = i + (1 - i) * k, k = c[0], d = c[1], r = c[2], p = c[3], q = c[4], y = c[5],
            v = c[6],
...
THREE.extend(THREE.Frustum.prototype, {
    set: function (a, b, c, d, e, f) {
        ...
        var b = this.planes, c = a.elements, a = c[0], d = c[1], e = c[2], f = c[3], g = c[4], h = c[5], i = c[6], k = c[7], l = c[8], m = c[9], n = c[10],
            s = c[11], r = c[12], p = c[13], q = c[14], c = c[15];
    ...
    var b = new a.Sphere, c = new a.Ray, d = new a.Plane, e = new a.Vector3, f = new a.Vector3, g = new a.Matrix4,
        h = function (a, b) {
            ...
            if (h instanceof a.Particle) {
                ...
                var s = h.geometry, r = s.vertices, p = h.material instanceof a.MeshFaceMaterial, q = !0 === p ? h.material.materials : null,
                    y = h.material.side, v, z, t, A = i.precision;
...
THREE.Projector                                           = function () {
    ...
    var e, f, g = [], h = 0, i, k, l = [], m = 0, n, s, r = [], p = 0, q, y = [], v = 0, z, t, A = [], I = 0, C, x, G = [], J = 0,
        E = {objects: [], sprites: [], lights: [], elements: []}, H = new THREE.Vector3, B = new THREE.Vector4,
        W = new THREE.Box3(new THREE.Vector3(-1, -1, -1), new THREE.Vector3(1, 1, 1)), F = new THREE.Box3, K = Array(3), L = Array(4),
        U = new THREE.Matrix4, fa = new THREE.Matrix4, Ca, $a = new THREE.Matrix4, M = new THREE.Matrix3, ca = new THREE.Matrix3,
        qa = new THREE.Vector3, ha = new THREE.Frustum, ra = new THREE.Vector4, N = new THREE.Vector4;
...
THREE.Geometry.prototype                                  = {
    constructor: THREE.Geometry, applyMatrix: function (a) {
        ...
        for (b = this.morphTargets.length; a < b; a++) {
            if (!this.morphNormals[a]) {
                ...
                for (d = this.faces.length; c < d; c++) e = this.faces[c], i = new THREE.Vector3, k = e instanceof THREE.Face3 ? {
                    ...
                    b: new THREE.Vector3,
                    c: new THREE.Vector3
                } : {a: new THREE.Vector3, b: new THREE.Vector3, c: new THREE.Vector3, d: new THREE.Vector3}, g.push(i), h.push(k)
            }
        ...
        var b, c, d, e, f, g, h, i, k, l, m, n, s, r, p, q, y, v, z, t, A, I, C, x, G = [], J = [], E = new THREE.Vector3, H = new THREE.Vector3,
            B = new THREE.Vector3, W = new THREE.Vector3, F = new THREE.Vector3;
        b                                                                                                                    = 0;
...
THREE.BufferGeometry.prototype                            = {
    constructor: THREE.BufferGeometry, applyMatrix: function (a) {
        ...
        if (this.attributes.position) {
            ...
            var e = this.attributes.position.array, f = this.attributes.normal.array, g, h, i, k, l, m, n = new THREE.Vector3, s = new THREE.Vector3,
                r = new THREE.Vector3, p = new THREE.Vector3, q = new THREE.Vector3;
        ...
        if (void 0 === this.attributes.index || void 0 === this.attributes.position ||
            ...
            var b = this.attributes.index.array, c = this.attributes.position.array, d = this.attributes.normal.array, e = this.attributes.uv.array,
                f = c.length / 3;
...
THREE.PerspectiveCamera.prototype.updateProjectionMatrix  = function () {
    if (this.fullWidth) {
        var a = this.fullWidth / this.fullHeight, b = Math.tan(THREE.Math.degToRad(0.5 * this.fov)) * this.near, c = -b, d = a * c, a = Math.abs(a * b - d),
            c = Math.abs(b - c);
...
THREE.CanvasRenderer                                      = function (a) {
    ...
    var k                                                                                                                       = THREE.Math.smoothstep, a = a || {}, l = this, m, n, s, r = new THREE.Projector,
        ...
        K, L, U, fa, Ca                                                                                                         = new THREE.RenderableVertex, $a = new THREE.RenderableVertex, M, ca, qa, ha, ra, N, Ma, Na, mb, Pa, ta, ka,
        aa                                                                                                                      = new THREE.Color, pa                                                                                                = new THREE.Color, Y = new THREE.Color, da =
            new THREE.Color, la = new THREE.Color, Z = new THREE.Color, oa = new THREE.Color, gb = new THREE.Color, nb = {}, ia = {}, Wa, ab,
        Fa, Xa, ub, Ib, Jb, fc, Ab, mc, pb = new THREE.Box2, Ka = new THREE.Box2, Va = new THREE.Box2, gc = !1, vb = new THREE.Color,
        Qa = new THREE.Color, La = new THREE.Color, bb = new THREE.Vector3, xb, j, yb, Ra, cb, Sa, zb = 16;
    ...
    this.render                 = function (a, p) {
        ...
        function F(a, b, c, d, e, f, g, j, i, wa, k, l, n) {
            if (!(n instanceof THREE.DataTexture || void 0 === n.image || 0 == n.image.width)) {
                ...
                var m                                                                                                            = n.offset.x /
                    n.repeat.x, hb = n.offset.y / n.repeat.y, p = n.image.width * n.repeat.x, q = n.image.height * n.repeat.y, g = (g + m) * p,
                    j = (1 - j + hb) * q, c = c - a, d = d - b, e = e - a, f = f - b, i = (i + m) * p - g, wa = (1 - wa + hb) * q - j,
                    k = (k + m) * p - g, l = (1 - l + hb) * q - j, m = i * l - k * wa;
...
THREE.WebGLRenderer                                       = function (a) {
    ...
    var a                                                                                                                           = a || {}, U                                                                                                              = void 0 !== a.canvas ? a.canvas : document.createElement("canvas"),
        ...
        ha                                                                                                                          = void 0 !== a.clearColor ? new THREE.Color(a.clearColor) : new THREE.Color(0), ra = void 0 !== a.clearAlpha ? a.clearAlpha : 0;
    this.domElement                                                                                                                 = U;
    this.context                                                                                                                    = null;
    ...
    var N = this, Ma = [], Na = 0, mb = null, Pa = null, ta = -1, ka = null, aa = null, pa = 0, Y = 0, da = -1, la = -1, Z = -1, oa = -1,
        gb = -1, nb = -1, ia = -1, Wa = -1, ab = null, Fa = null, Xa = null, ub = null, Ib = 0, Jb = 0, fc = 0, Ab = 0, mc = 0, pb = 0,
        Ka = {}, Va = new THREE.Frustum, gc = new THREE.Matrix4, vb = new THREE.Matrix4, Qa = new THREE.Vector3, La = new THREE.Vector3,
        bb = !0, xb = {
            ambient: [0, 0, 0],
        ...
        for (; a.__objectsAdded.length;) {
            ...
            if (!b.__webglInit) if (b.__webglInit = !0, b._modelViewMatrix = new THREE.Matrix4, b._normalMatrix = new THREE.Matrix3, void 0 !== b.geometry && void 0 === b.geometry.__webglInit && (b.geometry.__webglInit = !0, b.geometry.addEventListener("dispose", wd)), b instanceof THREE.Mesh) if (m = b.geometry, p = b.material, m instanceof THREE.Geometry) {
                if (void 0 === m.geometryGroups) {
                    var s                                                                                        =
                            m, x = void 0, C = void 0, B = void 0, A = void 0, F = void 0, E = void 0, G = {}, I = s.morphTargets.length,
                        J = s.morphNormals.length, K = p instanceof THREE.MeshFaceMaterial;
                    s.geometryGroups = {};
                    x = 0;
            ...
            if (ta instanceof THREE.Mesh) if (O instanceof THREE.BufferGeometry) (O.verticesNeedUpdate || O.elementsNeedUpdate || O.uvsNeedUpdate || O.normalsNeedUpdate || O.colorsNeedUpdate || O.tangentsNeedUpdate) && i(O, j.DYNAMIC_DRAW, !O.dynamic), O.verticesNeedUpdate = !1, O.elementsNeedUpdate = !1, O.uvsNeedUpdate = !1, O.normalsNeedUpdate = !1, O.colorsNeedUpdate = !1, O.tangentsNeedUpdate =
                ...
                for (var Ca = 0, Ka = O.geometryGroupsList.length; Ca < Ka; Ca++) if (mb = O.geometryGroupsList[Ca], ia = e(ta, mb), O.buffersNeedUpdate && d(mb, ta), qa = ia.attributes && y(ia), O.verticesNeedUpdate || O.morphTargetsNeedUpdate || O.elementsNeedUpdate || O.uvsNeedUpdate || O.normalsNeedUpdate || O.colorsNeedUpdate || O.tangentsNeedUpdate || qa) {
                    ...
                    if (sa.__inittedArrays) {
                        var gb                                                                                                                        = f(Fa), Wa                                                                                                            = Fa.vertexColors ? Fa.vertexColors : !1, bb                                                               = g(Fa), $a = gb === THREE.SmoothShading, D = void 0, V       = void 0,
                            Ra                                                                                                                        = void 0,
                            Q = void 0, ab = void 0, Xa = void 0, Sa = void 0, nb = void 0, cb = void 0, pb = void 0, ub = void 0, R = void 0, S = void 0,
                            T = void 0, na = void 0, Mb = void 0, Nb = void 0, Ob = void 0, xb = void 0, Pb = void 0, Qb = void 0, Rb = void 0, yb = void 0,
                            Sb = void 0, Tb = void 0, Ub = void 0, zb = void 0, Vb = void 0, Wb = void 0, Xb = void 0, Ib = void 0, Yb = void 0, Zb = void 0,
                            $b = void 0, Jb = void 0, xa = void 0, fc = void 0, nc = void 0, Ab = void 0, yc = void 0, db = void 0, mc = void 0, Ya = void 0,
                            Za = void 0, oc = void 0, hc = void 0, Oa = 0, Ua = 0, ic = 0, jc = 0, Eb = 0, kb = 0, Aa = 0, ob = 0, Ta = 0, ba = 0, ja = 0,
                            w = 0, ya = void 0, eb = sa.__vertexArray,
                            Dc                                                                                                                        = sa.__uvArray, Ec                                                                                                     = sa.__uv2Array, Fb                                                                                 = sa.__normalArray, Ga = sa.__tangentArray, fb = sa.__colorArray,
                            Ha                                                                                                                        = sa.__skinIndexArray, Ia                                                                                              = sa.__skinWeightArray, sc = sa.__morphTargetsArrays, tc                                     = sa.__morphNormalsArrays,
                            od                                                                                                                        = sa.__webglCustomAttributesList, u = void 0, ac = sa.__faceArray, wb = sa.__lineArray, qb = La.geometry,
                            Mc                                                                                                                        = qb.elementsNeedUpdate, Cc = qb.uvsNeedUpdate, Nc                                                                     = qb.normalsNeedUpdate, Oc = qb.tangentsNeedUpdate, Pc = qb.colorsNeedUpdate,
                            fd                                                                                                                        = qb.morphTargetsNeedUpdate, uc = qb.vertices, ua                                                                      = sa.faces3, va = sa.faces4, lb = qb.faces, pd = qb.faceVertexUvs[0],
                ...
                if (O.verticesNeedUpdate || O.colorsNeedUpdate || O.normalsNeedUpdate || qa) {
                    var Gb = O, Rc = j.DYNAMIC_DRAW, Fc = void 0, Gc = void 0, Hc = void 0, Sc = void 0, za = void 0, Tc = void 0, Uc = void 0, Vc = void 0,
                        xd = void 0, ib = void 0, zc = void 0, Da = void 0, rb = void 0, yd = Gb.vertices, zd = Gb.colors, Ad = Gb.normals, gd = yd.length,
                        hd = zd.length, id = Ad.length, Wc = Gb.__vertexArray, Xc = Gb.__colorArray, Yc = Gb.__normalArray,
                ...
                if (O.verticesNeedUpdate || O.colorsNeedUpdate || O.lineDistancesNeedUpdate || qa) {
                    var Hb                                                                                                                           = O, Zc                                                                                                                   = j.DYNAMIC_DRAW, Ic                                                                                              = void 0, Jc = void 0, Kc = void 0, $c = void 0, Ja                                          = void 0, ad = void 0, Bd                = Hb.vertices,
                        Cd                                                                                                                           = Hb.colors, Dd                                                                                                           = Hb.lineDistances, ld                                                                                    = Bd.length, Jd = Cd.length, Kd = Dd.length, bd = Hb.__vertexArray, cd = Hb.__colorArray,
                        Ed                                                                                                                           = Hb.__lineDistanceArray, Ld                                                                                              = Hb.colorsNeedUpdate,
                        Md = Hb.lineDistancesNeedUpdate, sd = Hb.__webglCustomAttributesList, dd = void 0, Fd = void 0, jb = void 0, Ac = void 0, sb = void 0,
                        Ea = void 0;
                ...
                if (O.verticesNeedUpdate || O.colorsNeedUpdate || ta.sortParticles || qa) {
                    var bc = O, td = j.DYNAMIC_DRAW, Lc = ta, tb = void 0, cc = void 0, dc = void 0, ga = void 0, ec = void 0, rc = void 0, ed = bc.vertices,
                        ud = ed.length, vd = bc.colors, Gd = vd.length, wc = bc.__vertexArray, xc = bc.__colorArray, kc = bc.__sortArray,
                        Hd = bc.verticesNeedUpdate, Id = bc.colorsNeedUpdate,
...
THREE.GeometryUtils                                       = {
    merge: function (a, b) {
        var c, d, e = a.vertices.length, f = b instanceof THREE.Mesh ? b.geometry : b, g = a.vertices, h = f.vertices, i = a.faces, k = f.faces,
            l = a.faceVertexUvs[0], f = f.faceVertexUvs[0];
...
THREE.ImageUtils                                          = {
    crossOrigin: "anonymous", loadTexture: function (a, b, c, d) {
        ...
        for (var h                                                    = g.getImageData(0,
            ...
            var n = 0 > m - 1 ? 0 : m - 1, s = m + 1 > e - 1 ? e - 1 : m + 1, r = 0 > l - 1 ? 0 : l - 1, p = l + 1 > d - 1 ? d - 1 : l + 1, q = [],
        ...
        for (k = e - 1; 2 < e;) {
            ...
            a:{
                ...
                if (1E-10 > (p - s) * (v - r) - (q - r) * (y - s)) n = !1; else {
                    var A = void 0, I = void 0, C = void 0, x = void 0, G = void 0, J = void 0, E = void 0, H = void 0, B = void 0, W = void 0,
                        B = H = E = t = z = void 0, A = y - p, I = v - q, C = s - y, x = r - v, G = p - s, J = q - r;
...
THREE.Animation.prototype.play                               = function (a, b) {
    if (!1 === this.isPlaying) {
        ...
        for (c = 0; c < d; c++) {
            ...
            void 0 === e.animationCache && (e.animationCache = {}, e.animationCache.prevKey = {pos: 0, rot: 0, scl: 0}, e.animationCache.nextKey = {
                pos: 0,
                rot: 0,
                scl: 0
...
THREE.CombinedCamera.prototype.toOrthographic                = function () {
    var a = this.cameraP.aspect, b = (this.cameraP.near + this.cameraP.far) / 2, b = Math.tan(this.fov / 2) * b, a = 2 * b * a / 2,
        b = b / this.zoom, a = a / this.zoom;
    this.cameraO.left = -a;
...
THREE.CylinderGeometry                                       = function (a, b, c, d, e, f) {
    ...
    for (h = 0; h < d; h++) {
        ...
        for (i = 0; i < e; i++) {
            var s = k[i][h], r = k[i + 1][h], p = k[i + 1][h + 1], q = k[i][h + 1], y = m.clone(), v = m.clone(), z = n.clone(), t = n.clone(),
                A = l[i][h].clone(), I = l[i + 1][h].clone(), C = l[i + 1][h + 1].clone(), x = l[i][h + 1].clone();
...
THREE.ExtrudeGeometry.prototype.addShape                     = function (a, b) {
    ...
    function d(a, b, c) {
        var d = THREE.ExtrudeGeometry.__v1, e = THREE.ExtrudeGeometry.__v2, f = THREE.ExtrudeGeometry.__v3, g = THREE.ExtrudeGeometry.__v4,
            i = THREE.ExtrudeGeometry.__v5, h = THREE.ExtrudeGeometry.__v6;
    ...
    function e(c, d) {
        ...
        for (M = c.length; 0 <= --M;) {
            ...
            for (var g = 0, i = s + 2 * l,
                     g        = 0; g < i; g++) {
                var h = fa * g, k = fa * (g + 1), m = d + e + h, h = d + f + h, n = d + f + k, k = d + e + k, p = c, q = g, r = i, t = e, y = f, m = m + H,
                    h = h + H, n = n + H, k = k + H;
    ...
    var h                                                                                                                            = void 0 !== b.amount ? b.amount :
        ...
        n = void 0 !== b.curveSegments ? b.curveSegments : 12, s = void 0 !== b.steps ? b.steps : 1, r = b.extrudePath, p, q = !1, y = b.material,
        v = b.extrudeMaterial, z = void 0 !== b.UVGenerator ? b.UVGenerator : THREE.ExtrudeGeometry.WorldUVGenerator, t, A, I, C;
...
THREE.SphereGeometry                                         = function (a, b, c, d, e, f, g) {
    ...
    for (c = 0; c < this.heightSegments; c++) for (b = 0; b < this.widthSegments; b++) {
        var d = h[c][b + 1], e = h[c][b], f = h[c + 1][b], g = h[c + 1][b + 1], k = this.vertices[d].clone().normalize(),
            l = this.vertices[e].clone().normalize(), m = this.vertices[f].clone().normalize(), n = this.vertices[g].clone().normalize(),
            s = i[c][b + 1].clone(), r = i[c][b].clone(), p = i[c + 1][b].clone(),
            q                                                                                     = i[c + 1][b + 1].clone();
...
THREE.TorusGeometry                                          = function (a, b, c, d, e) {
    ...
    for (c = 1; c <= this.radialSegments; c++) for (d = 1; d <= this.tubularSegments; d++) {
        var e = (this.tubularSegments + 1) * c + d - 1, f = (this.tubularSegments + 1) * (c - 1) + d - 1, g = (this.tubularSegments + 1) * (c - 1) + d,
            h = (this.tubularSegments + 1) * c + d, i = new THREE.Face4(e, f, g, h, [b[e], b[f], b[g], b[h]]);
        i.normal.add(b[e]);
        i.normal.add(b[f]);
        i.normal.add(b[g]);
        i.normal.add(b[h]);
...
THREE.TorusKnotGeometry                                      = function (a, b, c, d, e, f, g) {
    ...
    for (a = 0; a < this.radialSegments; ++a) {
        ...
        for (b = 0; b < this.tubularSegments; ++b) {
            var i = 2 * (a / this.radialSegments) * this.p * Math.PI, g = 2 * (b / this.tubularSegments) * Math.PI,
                f = h(i, g, this.q, this.p, this.radius, this.heightScale), i = h(i + 0.01, g, this.q, this.p, this.radius, this.heightScale);
            c.subVectors(i, f);
            d.addVectors(i, f);
            e.crossVectors(c, d);
            d.crossVectors(e, c);
    ...
    for (a = 0; a < this.radialSegments; ++a) for (b = 0; b < this.tubularSegments; ++b) {
        var e = (a + 1) % this.radialSegments, f = (b + 1) % this.tubularSegments, c = this.grid[a][b], d = this.grid[e][b], e = this.grid[e][f],
            f = this.grid[a][f], g = new THREE.Vector2(a / this.radialSegments, b / this.tubularSegments),
...
THREE.DirectionalLightHelper                                 = function (a, b) {
    ...
    var c = this.color.getHex(), d = new THREE.SphereGeometry(b, 16, 8), e = new THREE.AsteriskGeometry(1.25 * b, 2.25 * b),
        f = new THREE.MeshBasicMaterial({color: c, fog: !1}), g = new THREE.LineBasicMaterial({color: c, fog: !1});
    this.lightSphere =
        new THREE.Mesh(d, f);
...
THREE.PointLightHelper                                       = function (a, b) {
    ...
    this.color    = a.color.clone();
    this.color.multiplyScalar(c);
    var d = this.color.getHex(), c = new THREE.SphereGeometry(b, 16, 8), e = new THREE.AsteriskGeometry(1.25 * b, 2.25 * b),
        f = new THREE.IcosahedronGeometry(1, 2), g = new THREE.MeshBasicMaterial({color: d, fog: !1}),
...
THREE.SpotLightHelper                                        = function (a, b) {
    ...
    this.color.multiplyScalar(c);
    var c = this.color.getHex(), d = new THREE.SphereGeometry(b, 16, 8), e = new THREE.AsteriskGeometry(1.25 * b, 2.25 * b),
        f = new THREE.CylinderGeometry(1E-4, 1, 1, 8, 1, !0), g = new THREE.Matrix4;
    g.rotateX(-Math.PI / 2);
...
THREE.LensFlarePlugin                                        = function () {
    ...
    this.render = function (a, d, e, f) {
        ...
        if (v) {
            var z = new THREE.Vector3, t = f / e, A = 0.5 * e, I = 0.5 * f, C = 16 / f, x = new THREE.Vector2(C * t, C), G = new THREE.Vector3(1, 1, 0),
                J = new THREE.Vector2(1, 1), E = s, C = n;
            b.useProgram(m);
...
THREE.SpritePlugin                                           = function () {
    ...
    this.init   = function (a) {
        ...
        b.bindBuffer(b.ELEMENT_ARRAY_BUFFER, h);
        b.bufferData(b.ELEMENT_ARRAY_BUFFER, f, b.STATIC_DRAW);
        var a = THREE.ShaderSprite.sprite, n = b.createProgram(), s = b.createShader(b.FRAGMENT_SHADER), r = b.createShader(b.VERTEX_SHADER),
            p = "precision " + d + " float;\n";
